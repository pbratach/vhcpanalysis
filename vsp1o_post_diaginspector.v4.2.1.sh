...
echo " "
echo "Script version 4.2.1 (01/12/2026)"
...
if [[ -n "$output" ]]; then
	...
	echo -e "\033[0;31mCould not find file vspo_serial_number_get.log\033[0m"
fi
echo " "
...
if [[ -n "$output" ]]; then
	...
	echo -e "\033[0;31mCould not find file vspo_kubectl_version_short.log\033[0m"
fi
echo " "
...
if [[ -n "$output" ]]; then
	...
	echo -e "\033[0;31mCould not find file vspo_galaxy_info.log\033[0m"
fi
echo " "
...
if [[ -n "$output" ]]; then
	...
	echo -e "\033[0;31mCould not find file find vspo_telemetry_report.log\033[0m"
fi
echo " "
...
if [ $(echo "$output" | wc -l) -gt 1 ]; then
  echo " "
  echo -e "\033[0;31mToo big clock skew is detected\033[0m"
  echo "$output"
  echo -e "\033[0;31m##########################################\033[0m"
fi
